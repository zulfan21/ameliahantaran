...
@section('title', 'Kontak Kami - Amelia Hantaran')
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $settings['company_address'] ?? 'Jl. Mawar No. 123, Jakarta Selatan' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $settings['company_phone'] ?? '0812-3456-7890' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $settings['company_email'] ?? 'hello@ameliahantaran.com' }}</p>
                            </div>
                        </div>
                        ...
                        @else
                            <div class="w-full h-full flex items-center justify-center bg-cream-50">
                                <div class="text-center p-8">
                                    ...
                                    <p class="text-gray-400 text-sm mt-2">{{ $settings['company_address'] ?? 'Jl. Mawar No. 123, Jakarta Selatan' }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
