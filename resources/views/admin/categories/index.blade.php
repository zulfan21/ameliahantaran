                        ...
                        @forelse($categories as $category)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-center">
                                    <span
                                        class="px-2 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">{{ $category->products_count }}</span>
                                </td>
                                <td class="py-3 px-4 text-center">
                                    <span
                                ...
                                <td class="py-3 px-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <button
                                            onclick="editCategory({{ $category->id }}, '{{ $category->name }}', '{{ $category->slug }}', '{{ $category->description }}', '{{ $category->icon }}', {{ $category->is_active ? 1 : 0 }})"
