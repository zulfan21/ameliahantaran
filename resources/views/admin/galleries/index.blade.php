...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <a href="{{ route('admin.galleries.create') }}" class="inline-flex items-center bg-primary-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-primary-600 transition-colors">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($galleries as $gallery)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="p-4">
                                    <p class="font-bold text-gray-900 text-base mb-1">{{ $gallery->title }}</p>
                                    <p class="text-sm text-gray-500 line-clamp-2">{{ $gallery->description ?? 'Tidak ada deskripsi' }}</p>
                                </td>
