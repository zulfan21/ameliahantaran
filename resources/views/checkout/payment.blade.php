    ...
    <section class="bg-gradient-to-br from-primary-50 to-cream-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-gray-600">
                Selesaikan pembayaran untuk pesanan <span class="font-semibold">{{ $order->order_number }}</span>
            </p>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border-2 border-primary-500 rounded-xl p-6">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-2xl font-bold text-primary-600">{{ $order->formattedTotal() }}</p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-white rounded-lg p-4 border border-gray-200">
                                ...
                                <div class="flex justify-between items-center">
                                    <div>
                                        <p class="text-2xl font-bold text-gray-900">{{ $bankInfo['account'] }}</p>
                                        <p class="text-sm text-gray-500">a.n {{ $bankInfo['account_name'] }}</p>
                                    </div>
                                    <button onclick="copyToClipboard('{{ $bankInfo['account'] }}')"
                ...
                <div>
                    <div class="bg-white border border-gray-200 rounded-xl p-6 sticky top-24">
                        ...
                        <form action="{{ route('orders.upload-payment', $order->order_number) }}" method="POST"
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="amount" class="block text-sm font-medium text-gray-700 mb-1">Jumlah
                                            Transfer</label>
                                        <input type="number" name="amount" id="amount" value="{{ $order->total }}"
                                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500"
                                            required>
                                    </div>
                                    <div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-200">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-primary-600">{{ $order->formattedTotal() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
