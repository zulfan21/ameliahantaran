<?php $__env->startSection('title', 'Amelia Hantaran - Make Your Wedding Hantaran Truly Special'); ?>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-gray-600 text-lg mb-8 max-w-lg mx-auto lg:mx-0">
                        <?php echo e($settings['company_description'] ?? 'Elegant hantaran decoration, premium rental boxes, and complete seserahan packages for your unforgettable wedding moment.'); ?>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('products.index', ['category' => $category->id])); ?>"
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center text-white p-4">
                            <i data-lucide="<?php echo e($category->icon ?? 'gift'); ?>" class="w-12 h-12 mb-3"></i>
                            <h3 class="font-semibold text-lg text-center"><?php echo e($category->name); ?></h3>
                            <span class="text-sm text-primary-100 mt-1"><?php echo e($category->products_count); ?> Produk</span>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                        ...
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="swiper-slide !h-auto">
                                <div
                                    ...
                                    <p class="text-gray-600 mb-6 italic line-clamp-4">"<?php echo e($testimonial->content); ?>"</p>
                                    <div class="flex items-center mt-auto pt-4 border-t border-gray-50">
                                        <div
                                            ...
                                            <span
                                                class="text-primary-600 font-semibold"><?php echo e(substr($testimonial->customer_name ?? 'P', 0, 1)); ?></span>
                                        </div>
                                        <div>
                                            <h4 class="font-semibold text-gray-900 text-sm">
                                                <?php echo e($testimonial->customer_name ?? 'Pelanggan'); ?></h4>
                                            <?php if($testimonial->wedding_date): ?>
                                                <p class="text-xs text-gray-500"><?php echo e($testimonial->wedding_date); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\zulfa\OneDrive\Documents\amelia-hantaran\resources\views/home.blade.php ENDPATH**/ ?>