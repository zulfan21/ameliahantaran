            ...
            <div class="grid lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" maxlength="20"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="min_order" id="min_order" value="<?php echo e(old('min_order', 1)); ?>"
                            min="1"
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="file" name="images[]" id="images" accept="image/*" multiple
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-500 <?php $__errorArgs = ['images'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
