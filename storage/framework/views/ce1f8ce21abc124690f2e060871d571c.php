    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="lg:col-span-3">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <span
                            class="text-gray-400 text-sm leading-relaxed mt-1"><?php echo e($settings['company_address']); ?></span>
                    </li>
                    <li class="flex items-center">
                        <div class="w-8 h-8 rounded bg-gray-800 flex items-center justify-center flex-shrink-0 mr-3">
                            <i data-lucide="phone" class="w-4 h-4 text-primary-400"></i>
                        </div>
                        <span class="text-gray-400 text-sm"><?php echo e($settings['company_phone']); ?></span>
                    </li>
                    <li class="flex items-center">
                        <div class="w-8 h-8 rounded bg-gray-800 flex items-center justify-center flex-shrink-0 mr-3">
                            <i data-lucide="mail" class="w-4 h-4 text-primary-400"></i>
                        </div>
                        <span class="text-gray-400 text-sm"><?php echo e($settings['company_email']); ?></span>
                    </li>
                    <li class="flex items-center">
                        <div class="w-8 h-8 rounded bg-gray-800 flex items-center justify-center flex-shrink-0 mr-3">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($settings['company_name']); ?>. All rights reserved.
            </p>
...
<?php /**PATH C:\Users\zulfa\OneDrive\Documents\amelia-hantaran\resources\views/layouts/footer.blade.php ENDPATH**/ ?>